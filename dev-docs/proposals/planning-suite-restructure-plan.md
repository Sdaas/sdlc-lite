...
- ✅ **Doc (3) DONE + approved** — `dev-docs/proposals/planning-suite-architecture.md` (the durable spine:
...
- ✅ **Doc (4) DONE + approved** — `dev-docs/proposals/design-system.md` (tier internals: purpose,
...
- ✅ **Doc (5) DONE + approved** — `dev-docs/proposals/plan-feature.md` (REPLACED the concept doc).
...
- ✅ **Launch-pad deleted** — `git rm dev-docs/proposals/2026-09-20-planning-suite-architecture.md` (fully
  absorbed by (3)(4)(5)).
...
4. **Doc structure to produce (durable, in `dev-docs/proposals/`):**
...
1. [x] **DONE + approved** — Wrote **(3)** suite architecture (durable) as
       `dev-docs/proposals/planning-suite-architecture.md`; absorbs `2026-09-20-planning-suite-architecture.md`.
2. [~] **(4) DONE + approved; (5) NEXT.** Wrote **(4)** `/design-system` (durable) as
       `dev-docs/proposals/design-system.md`. Still to do: **(5) stable-core** `/plan-feature` (durable;
...
6. [~] **Absorbed sources:** launch-pad `dev-docs/proposals/2026-09-20-planning-suite-architecture.md`
       **DELETED** ✓. `~/Desktop/plan-feature-analysis.md` original **pending user confirm** (content
       ...
       `dev-docs/proposals/plan-feature.md` — it *is* doc (5)** (old concept replaced in place). `git rm`
...
| File | Kind | Fate |
|---|---|---|
| `dev-docs/proposals/planning-suite-architecture.md` | **doc (3) — durable spine** | ✅ **CREATED + approved** (un-dated = durable) |
| `dev-docs/proposals/design-system.md` | **doc (4) — durable, `/design-system` tier** | ✅ **CREATED + approved** (incl. §3.3 reframe move + §8.1 eval scenario) |
| `dev-docs/proposals/2026-09-20-planning-suite-architecture.md` | research/synthesis; **the launch pad** | fully absorbed by (3)(4)(5); 🔜 **DELETE** (step 6) |
| `dev-docs/proposals/plan-feature.md` | **doc (5) — durable, `/plan-feature` tier** | ✅ **REPLACED in place + approved + standalone-cleaned** — this IS doc (5); **do NOT delete** |
